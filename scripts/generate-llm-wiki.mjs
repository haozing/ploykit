...
const capabilityDescriptions = {
  ...
  commercial: 'Host-managed commercial reads, usage charges, and digital checkout.',
...
const contractDescriptions = {
  ...
  profile: 'Required product profile: app, ai-tool, digital-commerce, or cms.',
  capabilities: 'Explicit host capability packages enabled by this module.',
  ...
  commercial: 'Commercial meters and entitlements used by the module.',
...
> Generated by \`node scripts/generate-llm-wiki.mjs\`. Do not edit this file by hand.
...
function writeOrCheck(file, content, diagnostics) {
  if (checkOnly) {
    ...
    if (existing !== content) {
      diagnostics.push(`${projectPath(file)} is stale. Run node scripts/generate-llm-wiki.mjs.`);
    }
    return;
  }
