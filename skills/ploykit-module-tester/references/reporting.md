...
Database/runtime:
- Docker/Postgres state, migrations, runtime store checks, failures

API/action:
- endpoints/actions tested, auth states, failures
...
- browser routes, viewports, screenshots, and observation notes
...
- relevant doctor/check/test/build commands pass
- relevant database/runtime checks pass
- relevant real API requests and negative cases behave correctly
- relevant pages were opened in a browser
- screenshots were captured and inspected
- no unexpected console, page, or network failures remain
