...
export const ADMIN_PAGES: readonly AdminPageCatalogEntry[] = [
  ...
  {
    id: 'admin.service-connections',
    sourcePath: 'src/app/[lang]/admin/service-connections/page.tsx',
    routePattern: '/admin/service-connections',
    path: '/en/admin/service-connections',
    tier: 'P0',
    title: 'Service Connections',
    smoke: { expectedText: ['Service Connections'] },
  },
  {
